<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ImportPS.ascx.cs" Inherits="tracuu_ImportPS" %>
<center>
...
<table border="0" width="600" cellpadding="6" id="tblCation" style="font-family: Arial; font-size: 10pt; border-collapse: collapse">
	        ...
	        <tr>
		        <td colspan="2" 
                    ...
                    bordercolor="#FF9900">
		        <p align="left"><b><font color="#FF9900">Upload dữ liệu phát sinh nộp thuế</font></b></td>
	        </tr>
	        <%--<tr>
