<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadDSNVP.aspx.cs" Inherits="UploadDSNVP" %>
	        ...
	        <tr>
                ...
                <tr>
                  ...
                  <tr>
		            ...
		            <td align="left" class="style11">
                        <asp:TextBox ID="textboxDong_Bat_Dau" runat="server" value="42" Width="135px"></asp:TextBox>
                                        </td>
	            </tr>
	            <tr>
