<%@ Control Language="C#" AutoEventWireup="true" CodeFile="R_Danh_sach_thu_phi_phat.ascx.cs" Inherits="tracuu_R_Danh_sach_thu_phi_phat" %>
        ...
        <td align="center">
	        ...
	        <tr>
		        <td colspan="2" 
                    ...
                    bordercolor="#FF9900">
		        <p align="left"><b><font color="#FF9900">Danh sách thu phí phạt</font>&nbsp;</b></td>
	        </tr>
               ...
               <tr>
                   ...
                   <td align="left" class="style10">
                         <asp:DropDownList ID="DropDownListloai" runat="server" Width="450px">
                                            <asp:ListItem >Mẫu chuẩn</asp:ListItem>
                                            <asp:ListItem Selected="True">Nhóm theo CQQD, Mã nghiệp vụ</asp:ListItem>
                        </asp:DropDownList>
                   </td>
               </tr>
                <tr>
